...
public class JdbcUserRepository implements UserRepository {
    ...
    public void saveUser(User user) {
        ...
        final String SAVE_USERNAME_AND_PASSWORD = "INSERT INTO users(name, password, role) VALUES(?,?,'EMPLOYEE');";
    ...
    public User getUser(User user) {
        ...
        final String GET_USER_FROM_USERS_QUERY = "SELECT name,password FROM users WHERE name = ?";
    ...
    public boolean validateUser(String name, String password) {
        ...
        final String GET_NAME_PASSWORD_FROM_USERS_QUERY = "SELECT name,password FROM users WHERE name = ? and password = ?";
        try {
